...
const (
	_Cap_name_0 = "CapIRQChipCapHLTCapMMUShadowCacheControlCapUserMemoryCapSetTSSAddr"
	_Cap_name_1 = "CapVAPICCapEXTCPUIDCapClockSourceCapNRVCPUSCapNRMemSlotsCapPITCapNopIODelayCapPVMMUCapMPStateCapCoalescedMMIOCapSyncMMU"
	_Cap_name_2 = "CapIOMMU"
	_Cap_name_3 = "CapDestroyMemoryRegionWorksCapUserNMICapSetGuestDebugCapReinjectControlCapIRQRoutingCapIRQInjectStatus"
	_Cap_name_4 = ""
)

var (
	_Cap_index_0 = [...]uint8{0, 10, 16, 40, 53, 66}
	_Cap_index_1 = [...]uint8{0, 8, 19, 33, 43, 56, 62, 75, 83, 93, 109, 119}
	_Cap_index_3 = [...]uint8{0, 27, 37, 53, 71, 84, 102}
	_Cap_index_4 = [...]uint16{0, 15, 40, 46, 54, 61, 76, 88, 100, 121, 130, 144, 164, 177, 187, 201, 210, 224, 237, 250, 269, 282, 294, 316, 325, 339, 351, 359, 366, 381, 395, 405, 418, 430, 446, 457, 466, 475, 486, 496, 506, 514, 523, 534, 553, 568, 579, 587, 602, 614, 631, 641, 656, 670, 686, 705, 717, 734, 743, 753, 772, 785, 795, 805, 815, 829, 845, 860, 873, 897, 911, 925, 945, 960, 972, 988, 1005, 1024, 1039, 1061, 1073, 1088, 1100, 1110, 1120, 1136, 1151, 1162, 1178, 1187, 1207, 1225, 1243, 1258, 1279, 1293, 1302, 1315, 1326, 1343, 1355, 1367, 1384, 1395, 1404, 1421, 1435, 1450, 1466, 1475, 1484, 1496, 1505, 1515, 1530, 1548, 1561, 1581, 1592, 1609, 1624, 1640, 1659, 1675, 1685, 1702, 1718, 1735, 1749, 1763, 1784, 1802, 1816, 1832, 1847, 1871, 1890, 1905, 1929, 1942, 1967, 1980, 1989, 2009, 2029, 2046, 2066, 2089, 2110, 2126, 2145, 2162, 2178, 2195, 2206, 2219, 2229, 2249, 2263, 2275, 2293, 2308, 2332, 2349, 2364, 2381, 2392, 2409, 2424, 2447, 2456, 2477, 2486, 2502, 2521, 2537, 2562, 2571, 2594, 2606, 2615, 2631, 2645, 2666, 2675, 2692, 2707, 2725, 2744, 2764, 2786, 2804, 2827, 2840, 2858, 2879}
)

func (i Cap) String() string {
	switch {
	case i <= 4:
		return _Cap_name_0[_Cap_index_0[i]:_Cap_index_0[i+1]]
	case 6 <= i && i <= 16:
		i -= 6
		return _Cap_name_1[_Cap_index_1[i]:_Cap_index_1[i+1]]
	case i == 18:
		return _Cap_name_2
	case 21 <= i && i <= 26:
		i -= 21
		return _Cap_name_3[_Cap_index_3[i]:_Cap_index_3[i+1]]
	case 29 <= i && i <= 223:
		i -= 29
		return _Cap_name_4[_Cap_index_4[i]:_Cap_index_4[i+1]]
	default:
